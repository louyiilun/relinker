...
def run(table_smi, sdf_path, out_mol_path, out_frag_path, out_link_path, out_table_path, progress=True):
    ...
    out_table.to_csv(out_table_path, index=False, mode='w', header=True)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--out_mol_sdf', action='store', type=str, required=True)
    parser.add_argument('--out_frag_sdf', action='store', type=str, required=True)
    parser.add_argument('--out_link_sdf', action='store', type=str, required=True)
    parser.add_argument('--out_table', action='store', type=str, required=True)
