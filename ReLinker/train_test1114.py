...
if __name__ == '__main__':
    ...
    p.add_argument('--samples_path', action='store', type=str,  default="sample1")
    ...
    rclogp_file_path = os.path.join(args.samples_path, "rclogp_value.txt")
    try:
        with open(rclogp_file_path, "r") as file:
            rclogp_value = file.readline().strip()
        rclogp = float(rclogp_value)
    except ValueError:
        print('========== the rclogp value nowhere to find ==========')
